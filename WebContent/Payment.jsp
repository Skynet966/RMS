...
<title>NAP: Rental Services</title>
<!-- for-mobile-apps -->
...
<body>
	<div class="main">
								...
								<div class="resp-tabs-container">
									...
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-3">	
										<div class="payment-info">
											...
											<form action="FinalSave" method="post">
												<div class="tab-for">				
													<h5>NAME ON CARD</h5>
														<input type="text" value="" required>
													<h5>CARD NUMBER</h5>													
														<input class="pay-logo" id="cardnumber" type="text" maxlength="16" value="0000-0000-0000-0000" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '0000-0000-0000-0000';}" required>
												</div>	
												<div class="transaction">
													<div class="tab-form-left user-form">
														<h5>EXPIRATION</h5>
													...
													<div class="tab-form-right user-form-rt">
														<h5>CVV NUMBER</h5>													
														<input required type="text" value="xxxx" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'xxxx';}">
													</div>
													<div class="clear"></div>
												</div>
												...
												<input type="hidden" name="a7" id="a7" value="">
												<input type="hidden" name="a8" id="a8" value="">
												<input type="hidden" name="a9" id="a9" value="">
												<input type="hidden" name="a10" id="a10" value="">
		...
		<p class="footer">Copyright © 2017 SNAP. All Rights Reserved | Design by <a href="https://w3layouts.com/" target="_blank" style="color:#91dd4d;">SKY-LABS</a></p>
	</div>
</body>
<script>
...
$(document).ready(function(){
	...
	$("#a1").attr("value","${paydtl[0]}");
	$("#a2").attr("value",ny+"-"+nm+"-"+nd);
	$("#a3").attr("value","${paydtl[2]}");
	$("#a4").attr("value","${paydtl[3]}");
	$("#a5").attr("value","${paydtl[4]}");
	$("#a6").attr("value","${paydtl[5]}");
	$("#a7").attr("value","${paydtl[6]}");
	$("#a8").attr("value","${paydtl[7]}");
	$("#a9").attr("value","${paydtl[8]}");
	$("#a10").attr("value","${logdtl[0]}");
	
	$("#b1").attr("value","${rcptdtl[0]}");
	$("#b2").attr("value","${rcptdtl[1]}");
	$("#b3").attr("value","${rcptdtl[2]}");
	$("#b4").attr("value","${rcptdtl[3]}");
	$("#b5").attr("value","${rcptdtl[4]}");
	$("#b6").attr("value","${rcptdtl[5]}");
});
</script>
</html>